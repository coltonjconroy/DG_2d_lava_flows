...
%load 'hawaii_fine_shift2_bpts.mat'
%load 'hawaii_fine2_shift2_bpts.mat'
%load 'hawaii_30_4_shift2_bpts.mat'
%load 'hawaii_5_half_shift2_bpts.mat'
if strcmpi(mesh_type,'old')
    load 'hawaii_30_3_bpts.mat'
else
    load 'hawaii_8_1_split_info.mat'
end
%load 'observations_hawaii'
offset = 111;
offset1 = 111;
avg_slope_1 = 2.8;
avg_slope_2 = 3.2;
...
xi = 0; xf = 400;
if strcmpi(mesh_type,'old')
    yi = 2169100.00 ; yf = 2169550.00;
else
    yi = 2169250.00 ; yf = 2169615.00;
end
...
%                sZx(j,i) = sind(2.8)*cos(atan(s_lb));
%                sZy(j,i) = sind(2.8)*sin(atan(s_lb));
                % centerline check
